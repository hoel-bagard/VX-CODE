...
from vx_code.explanations.vxcode import VXCODE
from vx_code.models.detr.d2.detr.config import add_detr_config
from vx_code.models.detr.d2.detr.trainer import TrainerDETR
from vx_code.utils.utils import get_target_instances_from_preds
from vx_code.visualizations.visualize import vis_vxcode_results
...
def compute_heatmaps(
    ...
    vxcode = VXCODE(model, model_name, mode=vxcode_mode, num_patches_per_step=num_patches_per_step)

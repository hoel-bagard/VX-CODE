...
def compute_predictions_for_proposals(
    ...
    if model_name == "faster_r_cnn":
        ...
        proposal_pred_boxes = model.roi_heads.box_predictor.predict_boxes(predictions, proposals)
        proposal_pred_scores = model.roi_heads.box_predictor.predict_probs(predictions, proposals)

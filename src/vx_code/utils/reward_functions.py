...
def compute_similarity_based_on_score_and_iou(
    ...
    # Get iou
    list_iou, _ = get_max_iou_id_in_proposals(target_box, target_label, pred_boxes, image_shape, model_name=model_name)
...
def get_max_iou_id_in_proposals(
    ...
    if model_name == "faster_r_cnn":
        ...
        for i in range(batch_size):
            ...
            proposal_boxes_i = proposal_boxes_i.tensor.view(-1, num_bbox_reg_classes, 4)  # R x C x 4
